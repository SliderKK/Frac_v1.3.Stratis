...
>>>>>>> a5b8ba25ba769c26b429f1b12bfffc29d2982b20
...
_player addBackpack "B_Bergen_rgr"; //BackPack
_player addUniform "U_B_survival_uniform"; //Uniform (must be supported by side)
...
_player addMagazines ["HandGrenade", 1]; //Grenades
...
_player addMagazines ["9Rnd_45ACP_Mag", 3]; //Add handgun magazines first so one gets loaded
...
_player selectWeapon "hgun_ACPC2_F"; //Select Active Weapon
