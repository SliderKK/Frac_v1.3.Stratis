...
switch (_boxType) do
{
	...
	_boxitems =
		[
			//first aid, medkit, tookit, gps, rangefinder, etc
			// Item type, Item class(es), # of items, # of magazines per weapon
			["itm", "muzzle_snds_L", RANDOM_BETWEEN(1,3)],
			["itm", "muzzle_snds_acp", RANDOM_BETWEEN(1,3)],
			["itm", "muzzle_snds_M", RANDOM_BETWEEN(1,3)],
			["itm", "muzzle_snds_H", RANDOM_BETWEEN(1,3)],
			["itm", "muzzle_snds_H_MG", RANDOM_BETWEEN(1,3)],
			["itm", "muzzle_snds_B", RANDOM_BETWEEN(1,3)],
			["itm", "muzzle_snds_338_black", RANDOM_BETWEEN(1,3)],
			["itm", "muzzle_snds_338_green", RANDOM_BETWEEN(1,3)],
